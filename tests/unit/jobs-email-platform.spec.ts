...
describe('Story 1.5 — Required Files Exist (AC-1)', () => {
	test.skip('[P1] 1.5-UNIT-007 — src/worker.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007b — src/lib/server/env.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007c — src/lib/server/jobs/boss.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007d — src/lib/server/jobs/queues.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007e — src/lib/server/jobs/index.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007f — src/lib/server/email/mailer.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007g — src/lib/server/jobs/handlers/smoke-email.ts exists', () => {
	...
	test.skip('[P1] 1.5-UNIT-007h — src/lib/server/jobs/handlers/send-email.ts exists', () => {
...
describe('Story 1.5 — package.json worker script (AC-1)', () => {
	test.skip('[P1] 1.5-UNIT-008 — package.json has "worker" script pointing to src/worker.ts', () => {
	...
	test.skip('[P1] 1.5-UNIT-008b — package.json dependencies include pg-boss', () => {
	...
	test.skip('[P1] 1.5-UNIT-008c — package.json dependencies include nodemailer', () => {
	...
	test.skip('[P1] 1.5-UNIT-008d — package.json dependencies include valibot', () => {
	...
	test.skip('[P1] 1.5-UNIT-008e — package.json devDependencies does NOT include @types/pg-boss', () => {
...
describe('Story 1.5 — ESLint no-restricted-imports rule (AC-5)', () => {
	test.skip('[P1] 1.5-UNIT-009 — eslint.config.js includes no-restricted-imports rule for $app/* and $env/dynamic*', () => {
	...
	test.skip('[P1] 1.5-UNIT-009b — bun run lint exits 0 after no-restricted-imports rule is added', () => {
	...
	test.skip('[P1] 1.5-UNIT-009c — env.ts does NOT import $env/dynamic/private', () => {
	...
	test.skip('[P1] 1.5-UNIT-009d — worker.ts does NOT import $app/* or $env/dynamic*', () => {
...
describe('Story 1.5 — .env.example SMTP vars (AC-6)', () => {
	test.skip('[P1] 1.5-UNIT-010 — .env.example contains SMTP_HOST', () => {
	...
	test.skip('[P1] 1.5-UNIT-010b — .env.example contains SMTP_PORT', () => {
		// THIS TEST WILL FAIL — .env.example does not have SMTP vars yet.
		const envExamplePath = path.join(PROJECT_ROOT, '.env.example');
		const content = readFileSync(envExamplePath, 'utf-8');
	...
	test.skip('[P1] 1.5-UNIT-010c — .env.example contains SMTP_FROM', () => {
		// THIS TEST WILL FAIL — .env.example does not have SMTP vars yet.
		const envExamplePath = path.join(PROJECT_ROOT, '.env.example');
		const content = readFileSync(envExamplePath, 'utf-8');
	...
	test.skip('[P1] 1.5-UNIT-010d — .env.example contains SMTP_DISPLAY_NAME (FR-083)', () => {
		// THIS TEST WILL FAIL — .env.example does not have SMTP vars yet.
...
describe('Story 1.5 — compose.yaml Mailpit service (AC-2)', () => {
	test.skip('[P1] 1.5-UNIT-011 — compose.yaml contains mailpit service', () => {
	...
	test.skip('[P1] 1.5-UNIT-011b — compose.yaml mailpit service exposes SMTP port 1025', () => {
	...
	test.skip('[P2] 1.5-UNIT-011c — compose.yaml mailpit service exposes web UI port 8025', () => {
		// THIS TEST WILL FAIL — compose.yaml does not have mailpit yet.
		const composePath = path.join(PROJECT_ROOT, 'compose.yaml');
		const content = readFileSync(composePath, 'utf-8');
...
describe('Story 1.5 — env.ts Valibot fail-fast (AC-6)', () => {
	test.skip('[P1] 1.5-UNIT-012 — env.ts exports `env` object with DATABASE_URL', () => {
		// THIS TEST WILL FAIL — env.ts does not exist yet.
	...
	test.skip('[P1] 1.5-UNIT-012b — env.ts uses v.safeParse and calls process.exit(1) on failure', () => {
		// THIS TEST WILL FAIL — env.ts does not exist yet.
	...
	test.skip('[P1] 1.5-UNIT-012c — env.ts validates all required SMTP vars', () => {
		// THIS TEST WILL FAIL — env.ts does not exist yet.
		// Verifies all AC-6 required SMTP env vars are in the schema.
		const envPath = path.join(PROJECT_ROOT, 'src', 'lib', 'server', 'env.ts');
		const content = readFileSync(envPath, 'utf-8');

		const requiredVars = ['DATABASE_URL', 'SMTP_HOST', 'SMTP_PORT', 'SMTP_FROM', 'SMTP_DISPLAY_NAME'];
...
describe('Story 1.5 — Quality Gates (Task 11)', () => {
	test.skip('[P1] 1.5-UNIT-013 — bun run lint exits 0', () => {
	...
	test.skip('[P1] 1.5-UNIT-013b — bun run check exits 0', () => {
	...
	test.skip('[P1] 1.5-UNIT-013c — bun run format --check exits 0', () => {
